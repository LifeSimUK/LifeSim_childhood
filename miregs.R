...
income0 <- c("linc0", "lincim0", "lincnc0",
             "incqnt0", "incqntim0", "incqntnc0",
             "inc0", "incim0", "incnc0",
             "lincqnt0", "lincqntim0", "lincqntnc0")
mdlincdis <- c("lincim0", "incqntim0", "incim0", "deldevim3", "lincqntim0")
...
for (rskfctr in rskfctrs) {
  ...
  ##### Specify formulas
  if (rskfctr == "teenbrth0") {
    #### Early Year disadvantages
    ### Teen Mother
    ## Base model
    con <- c(cntry1, rgn1, ethn, imd1, gpedu)
    frml <- paste("~ teenbrth + ", 
                  paste(con, collapse = " + "), 
                  sep = "")
    ## Including mediators
  } else if (rskfctr == "teenbrthim0") {
    frml <- paste("~ teenbrth ", 
  ...
  } else if (rskfctr == "teenbrthnc0") {
    frml <- paste("~ teenbrth ",
                  sep = "")
    ### Pre-term birth
    ## Base model
  } else if  (rskfctr == "pretrmbrth0") {
    frml <- paste("~ pretrm_1 + pretrm_2 + pretrm_3 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
                  "+ ethnicity_2 + ethnicity_3 + ethnicity_4 + ethnicity_5 + ethnicity_6 ", 
                  "+ imdqnt1_2 + imdqnt1_3 + imdqnt1_4 + imdqnt1_5 ", 
    ...
    frml <- paste("~ pretrm_1 + pretrm_2 + pretrm_3 ", 
                  ...
                  sep = "")
    ## Simple correlation only
  } else if (rskfctr == "pretrmbrthnc0") {
    frml <- paste("~ pretrm_1 + pretrm_2 + pretrm_3 ", 
                  sep = "")
    ### Low birth weight
    ## Base model
  } else if  (rskfctr == "lwbrthwt0") {
    frml <- paste("~ bthwt_1 + bthwt_2 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
    ...
    frml <- paste("~ bthwt_1 + bthwt_2 ", 
                  ...
                  sep = "")
    ## Simple correlation only
  } else if (rskfctr == "lwbrthwtnc0") {
    frml <- paste("~ bthwt_1 + bthwt_2 ", 
                  sep = "")
    ### Low height
    ## Base model
  } else if  (rskfctr == "lwht3") {
    frml <- paste("~ lwht3 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
                  "+ imdqnt3_2 + imdqnt3_3 + imdqnt3_4 + imdqnt3_5 ", 
    ...
    frml <- paste("~ lwht3 ", 
                  ...
                  sep = "")
    ## Simple correlation only
  } else if (rskfctr == "lwhtnc3") {
    frml <- paste("~ lwht3 ",
                  sep = "")
    ### Low height 2SD
    ## Base model
  } else if  (rskfctr == "lwht2sd3") {
    frml <- paste("~ lwht2sd3 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
                  "+ imdqnt3_2 + imdqnt3_3 + imdqnt3_4 + imdqnt3_5 ", 
    ...
    frml <- paste("~ lwht2sd3 ", 
                  ...
                  sep = "")
    ## Simple correlation only
  } else if (rskfctr == "lwht2sdnc3") {
    frml <- paste("~ lwht2sd3 ",
                  sep = "")
    ### Low height 1.5SD
    ## Base model
  } else if  (rskfctr == "lwht15sd3") {
    frml <- paste("~ lwht15sd3 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
                  "+ imdqnt3_2 + imdqnt3_3 + imdqnt3_4 + imdqnt3_5 ", 
                  "+ ethnicity_2 + ethnicity_3 + ethnicity_4 + ethnicity_5 + ethnicity_6 ", 
    ...
    frml <- paste("~ lwht15sd3 ", 
                  ...
                  sep = "")
    ## Simple correlation only
  } else if (rskfctr == "lwht15sdnc3") {
    frml <- paste("~ lwht15sd3 ",
                  sep = "")
    ### Disability
    ## Base model
  } else if  (rskfctr == "dsblty3") {
    frml <- paste("~ alc3 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
                  "+ imdqnt3_2 + imdqnt3_3 + imdqnt3_4 + imdqnt3_5 ", 
                  ...
                  "+ lincome123 ",
                  sep = "")
    bout <- bout[!(bout %in% alc3)]
    ## Including mediators
  } else if (rskfctr == "dsbltyim3") {
    frml <- paste("~ alc3 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
                  "+ imdqnt3_2 + imdqnt3_3 + imdqnt3_4 + imdqnt3_5 ", 
    ...
    bout <- bout[!(bout %in% alc3)]
    ## Simple correlation only
  } else if (rskfctr == "dsbltync3") {
    frml <- paste("~ alc3 ", 
                  sep = "") 
    bout <- bout[!(bout %in% alc3)]
    ### School Readiness
    ## Base model
  } else if  (rskfctr == "deldev3") {
    frml <- paste("~ deldev3 ", 
                  "+ country1_2 + country1_3 + country1_4 ", 
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9",
                  "+ imdqnt3_2 + imdqnt3_3 + imdqnt3_4 + imdqnt3_5 ", 
    ...
    tfrml <- paste("~ deldev3 ", 
                   ...
                   sep = "")
    ## Simple correlation only
  } else if (rskfctr == "deldevnc3") {
    frml <- paste("~ deldev3 ", 
                  sep = "")                                             
    #### Income
    ### Annual income
    ## Base model
  } else if (rskfctr == "inc0") {
    frml <- paste("~ aincome123",
                  "+ country1_2 + country1_3 + country1_4",
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9 ",
    ...
    frml <- paste("~ aincome123",
                  ...
                  sep = "")
    ## Simple correlation only
  } else if (rskfctr == "incnc0") {
    frml <- paste("~ aincome123",
                  sep = "")
    ### Log annual income
    ## Base model
  } else if (rskfctr == "linc0") {
    ...
    tfrml <- paste("~ laincome123",
                   ...
                   sep = "")
    ## Simple correlation only
  } else if (rskfctr == "lincnc0") {
    frml <- paste("~ laincome123",
                  sep = "")
    ### Log annual income*Income quintiles
    ## Base model
  } else if (rskfctr == "lincqnt0") {
    frml <- paste("~ laincome123 + lincqnt123_1 + lincqnt123_2 + lincqnt123_3 + lincqnt123_4",
                  "+ country1_2 + country1_3 + country1_4",
                  "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9 ",
                  "+ ethnicity_2 + ethnicity_3 + ethnicity_4 + ethnicity_5 + ethnicity_6 ", 
                  "+ smokepreg1",
    ...
    frml <- paste("~ laincome123 + lincqnt123_1 + lincqnt123_2 + lincqnt123_3 + lincqnt123_4",
                  ...
                  "+ alc23",
                  sep = "")
    tfrml <- paste("~ laincome123 + lincqnt123_1 + lincqnt123_2 + lincqnt123_3 + lincqnt123_4",
                   "+ country1_2 + country1_3 + country1_4",
                   "+ region1_1 + region1_2 + region1_3 + region1_4 + region1_5 + region1_6 + region1_8 + region1_9 ",
                   "+ imdqnt123_1 + imdqnt123_2 + imdqnt123_3 + imdqnt123_4 ",
                   "+ ethnicity_2 + ethnicity_3 + ethnicity_4 + ethnicity_5 + ethnicity_6 ", 
                   ...
                   sep = "")
    ## Simple correlation only
  } else if (rskfctr == "lincqntnc0") {
    frml <- paste("~ laincome123 + lincqnt123_1 + lincqnt123_2 + lincqnt123_3 + lincqnt123_4",
                  sep = "")
    ### Income quintiles
    ## Base model
  } else if (rskfctr == "incqnt0") {
